  ...
  >
    ...
    <div className="relative z-10 flex flex-col h-full">
      <div className="flex-grow transition-all duration-300 group-hover:translate-y-[-1rem]">
        <Icon 
          className={cn(
            "h-16 w-16 transform-gpu transition-all duration-300 ease-in-out group-hover:scale-90",
          ...
          <Link href="/" className="flex items-center">
            <div className="rounded-lg shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] dark:shadow-[0_20px_50px_rgba(255,_255,_255,_0.2)] transition-all duration-300 hover:scale-105">
              <Image
                ...
                className="rounded-lg shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] dark:shadow-[0_20px_50px_rgba(255,_255,_255,_0.2)] transition-all duration-300 hover:scale-105"
              />
            </div>
          </Link>
...
// Helper function for authentication (implement your actual auth logic here)
